...
function decodeBase64Content(str) {
	...
	// Files are written as UTF-8 bytes, but atob hands back one char per byte.
	// Re-read those bytes as UTF-8 so accented characters, dashes and symbols
	// survive; anything that isn't valid UTF-8 (images, audio) is left as-is.
	try {
